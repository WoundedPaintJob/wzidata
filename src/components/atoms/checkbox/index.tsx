...
const CheckBox = (props: CheckBoxProps) => {
  return (
    <Switch
      ...
      className="group relative inline-flex h-3 w-6 mt-1 flex-shrink-0 cursor-pointer items-center justify-center rounded-full focus:outline-none focus:ring-2 focus:ring-background focus:ring-offset-2"
    >
      <span
        aria-hidden="true"
        className={twMerge(
